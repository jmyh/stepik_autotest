...
try:
    ...
    input4 = browser.find_element_by_class_name("second_block").find_element_by_class_name("first")
    input4.send_keys("Russia")
    input5 = browser.find_element_by_class_name("second_block").find_element_by_class_name("second")
